 ...
 * @package       tokenAuth.Test.Case.Controller.Component.Auth
 * @since         tokenAuth v 1.0.5
 * @license       MIT License (http://www.opensource.org/licenses/mit-license.php)
 */

App::uses('AuthComponent', 'Controller/Component');
App::uses('JwtTokenAuthenticate', 'tokenAuth.Controller/Component/Auth');
...
/**
 * Test case for tokenAuthentication
 *
 * @package       tokenAuth.Test.Case.Controller.Component.Auth
 */
class JwtTokenAuthenticateTest extends CakeTestCase
{
    public $fixtures = array('plugin.tokenAuth.user');
